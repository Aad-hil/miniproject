...
(1, 'Ravi Kumar', 'Chennai', '9876543210', 'ravi.kumar@example.com'),
(2, 'Priya Sharma', 'Bangalore', '9123456780', 'priya.sharma@example.com'),
(3, 'Arun Singh', 'Hyderabad', '9988776655', 'arun.singh@example.com'),
(4, 'Meena Iyer', 'Mumbai', '9001122334', 'meena.iyer@example.com'),
(5, 'Karthik Raj', 'Delhi', '9112233445', 'karthik.raj@example.com');
